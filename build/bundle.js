...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsBootstrap = __webpack_require__(158);

	var _componentsBootstrap2 = _interopRequireDefault(_componentsBootstrap);

	(0, _reactDom.render)(_react2["default"].createElement(_componentsBootstrap2["default"], null), document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tabs = ['Home', 'Profile', 'Messages', 'Settings'];
	...
	var Bootstrap = (function (_React$Component) {
	    ...
	    function Bootstrap(props) {
	        ...
	        _get(Object.getPrototypeOf(Bootstrap.prototype), 'constructor', this).call(this, props);
	    }

	    _createClass(Bootstrap, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(NewTab, null);
	        }
	    }]);
	...
	var NewTab = (function (_React$Component2) {
	    _inherits(NewTab, _React$Component2);
	    ...
	    function NewTab(props) {
	        ...
	        _get(Object.getPrototypeOf(NewTab.prototype), 'constructor', this).call(this, props);

	        this._handleNavClick = function (show) {
	            _this.setState({
	                show: show
	            });
	        };

	        this._getActiveClass = function (tab) {
	            return _this.state.show == tab ? 'active' : '';
	        };
	        ...
	        value: function render() {
	            ...
	            var tabNodes = tabs.map(function (tab, index) {
	                return _react2['default'].createElement(TabNav, {
	                    activeClass: _this2._getActiveClass(tab),
	                    tab: tab,
	                    key: index,
	                    navClick: _this2._handleNavClick
	                });
	            });
	            var tabContents = tabs.map(function (tab, index) {
	                var activeClass = _this2.state.show == tab ? 'active' : '';
	...
	var TabNav = (function (_React$Component3) {
	    _inherits(TabNav, _React$Component3);
	    ...
	    function TabNav(props) {
	        ...
	        this._handleClick = function (e) {
	            e.preventDefault();
	            _this3.props.navClick(e.target.text);
	        };
	    }
	    ...
	    _createClass(TabNav, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'a',
	                    { href: '#', onClick: this._handleClick, ref: 'nav' },
	                    this.props.tab
	                )
	            );
	        }
	...
	var TabContent = (function (_React$Component4) {
	    _inherits(TabContent, _React$Component4);
	    ...
	    _createClass(TabContent, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { style: style, className: "tab-pane " + this.props.activeClass, ref: 'content' },
	                this.props.tab
	            );
	        }
	    }]);
